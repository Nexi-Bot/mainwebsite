...
<div class="min-h-screen flex items-center justify-center py-20 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md mx-auto text-center">
        <div class="mb-8">
            <h1 class="text-6xl font-bold text-orange-400 mb-4">403</h1>
            <h2 class="text-2xl font-bold text-white mb-4">Access Forbidden</h2>
            <p class="text-gray-400 mb-8">
                You don't have permission to access this resource. This could be due to insufficient privileges or server configuration.
            </p>
        </div>
